...
describe('TextService', () => {
  ...
  it('can read model', (done) => {
    ...
    const expectedIds=[
      ...
      'creation/reports/a/groupedBy(object)',
      'creation/reports/a/groupedBy/by(input)',
      'creation/reports/a/groupedBy/label(input)',
      'creation/reports/a/groupedBy/display(object)',
      'creation/reports/a/groupedBy/display/operation(list)',
      'creation/reports/a/groupedBy/display/of(input)',
      'creation/reports/a/groupedBy/display/label(input)',
      'creation/reports/a/sortedBy(object)',
      'creation/reports/a/sortedBy/by(input)',
