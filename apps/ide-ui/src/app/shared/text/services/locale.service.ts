...
export class LocaleService {
  texts = new Map<string, string> ([
    ...
    [DontCodeModel.APP_REPORTS, 'It will display the reports:'],
    [DontCodeModel.APP_REPORTS+'-desc', 'Design the reports you want to use'],
    [DontCodeModel.APP_REPORTS_TITLE, 'A report named'],
    ...
    [DontCodeModel.APP_REPORTS_GROUP_BY, 'by'],
    [DontCodeModel.APP_REPORTS_GROUP_BY+'-desc', 'The field to use for grouping'],
